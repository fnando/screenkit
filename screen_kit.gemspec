...
require_relative "lib/screen_kit/version"

Gem::Specification.new do |spec|
  spec.name    = "screenkit"
  spec.version = ScreenKit::VERSION
  spec.authors = ["Nando Vieira"]
  spec.email   = ["me@fnando.com"]
  spec.metadata = {"rubygems_mfa_required" => "true"}

  spec.summary     = "Terminal to screencast, simplified"
  spec.description = spec.summary
  spec.license     = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 3.4.0")

  github_url = "https://github.com/fnando/screen_kit"
